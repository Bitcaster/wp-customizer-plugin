...
class Wp_Customizer_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->wp_customizer, plugin_dir_url( __FILE__ ) . 'css/wp-customizer-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->wp_customizer, plugin_dir_url( __FILE__ ) . 'js/wp-customizer-admin.js', array( 'jquery' ), $this->version, false );
